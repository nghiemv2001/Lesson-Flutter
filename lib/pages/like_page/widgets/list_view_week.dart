...
class ListView_Notification_Week extends StatelessWidget {
  const ListView_Notification_Week({required this.notifications, Key? key})
      : super(key: key);
          ...
          Expanded(
            child: ListView.separated(
                ...
                itemBuilder: (contex, index) {
                  return (notifications[index].time.day == 7 &&
